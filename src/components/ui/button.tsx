...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-fg hover:brightness-110 hover:-translate-y-px hover:shadow-[0_6px_20px_var(--blob)]',
        destructive: 'bg-destructive text-destructive-fg hover:brightness-110',
        outline:
          'bg-card text-card-fg border border-border hover:border-ring hover:-translate-y-px hover:shadow',
        secondary: 'bg-secondary text-secondary-fg hover:bg-accent',
